        ...
        <div class="row">
        	<div class="col-12 table-responsive">
              ...
              <thead>
                ...
                <th width="197" class="text-center b-left">Data spare part</th>
                <th width="206" class="text-center b-left">Pemesanan</th>
                  <th width="206" class="text-center b-left">Perintah perbaikan</th>
                  <th width="206" class="text-center b-left">Perbaikan</th>
                  <th width="206" class="text-center b-left">Survey Layanan</th>
