...
@section('content')
 ...
 <div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <!-- MULAI TOMBOL TAMBAH --> 
            <a href="{{ route('PrintAll') }}" class="btn btn-primary mdi mdi-printer-settings"> Cetak Data</a>
            <br><br>

          
            <!-- MULAI TABLE -->
            <div class="table-responsive">
                <table class="table table-silver" id="laporan_perbaikan">
                <thead>
  ...
  <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                        ...
                        <td>
                <form action="{{ route('pemesanan.destroy',$k->id_pemesanan) }}" method="POST">

                   
                    <a class="btn btn-primary btn-sm" href="{{ route('pemesanan.edit',$k->id_pemesanan) }}">Edit</a>
