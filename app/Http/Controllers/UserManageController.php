...
class UserManageController extends Controller
{
    ...
    public function firstAccount(Request $req)
    {
        ...
        $access->spare_part = 1;
        $access->pemesanan = 1;
        $access->perintah_perbaikan = 1;
        $access->perbaikan = 1;
        $access->survey_layanan = 1;
        $access->save();
